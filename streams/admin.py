...
class CustomUserAdmin(UserAdmin):
    ...
    list_display = ('username', 'email', 'is_admin', 'is_approved', 'is_active', 'date_joined')
...
class LiveAdmin(admin.ModelAdmin):
    ...
    list_display = ('title', 'user', 'status', 'is_scheduled', 'scheduled_at', 'created_at')
